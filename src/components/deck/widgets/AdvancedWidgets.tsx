...
const terms = [
  ["Algorithm", "A repeatable procedure for turning inputs into outputs."], ["Feature", "A number the model is allowed to see."], ["Label", "The known answer used to train or test a supervised model."], ["Training set", "Examples used to fit the model."], ["Test set", "Untouched examples used once to measure performance."], ["Overfitting", "Learning noise in known data instead of a transferable pattern."], ["Precision", "Of the targets flagged, the fraction that were real."], ["Recall", "Of the real targets, the fraction the model found."], ["Clustering", "Grouping similar samples without an answer key."], ["Data leakage", "Information from the answer or test ground entering training."], ["Feature importance", "A measure of how strongly an input influenced predictions."], ["Inference", "Using a trained model to make a new prediction."], ["Uncertainty", "A quantified statement of what the model does not know."], ["Spatial cross-validation", "Testing on entire held-out areas rather than nearby random rows."],
];
