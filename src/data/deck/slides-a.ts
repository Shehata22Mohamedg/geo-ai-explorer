...
export const slidesA: Slide[] = [
  ...
  },
  {
    ...
    lead: "Four acts. Foundations, then building blocks, then applications, then judgement. Two breaks, deliberately placed at natural seams.",
    table: {
      ...
      rows: [
        ...
        ["I", "02 · The data universe", "40 min", "What shape is exploration data?"],
        ["—", "Break 1", "15 min", "Coffee"],
        ["II", "03 · From field to feature", "35 min", "How does rock become a table?"],
        ["II", "04 · How ML actually works", "50 min", "What is the model really doing?"],
        ["—", "Break 2", "15 min", "Stretch"],
        ["III", "05 · Across the value chain", "40 min", "Where is AI genuinely useful?"],
